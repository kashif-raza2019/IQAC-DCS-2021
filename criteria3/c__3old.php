        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab312","ch312");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_1_2", true);
         			   			 xhttp.send();
        		}
        	}
    ...
    <form>
        ...
        <table border="0" id="tab312">
            <tr>
                ...
                <th style="width:250px; padding:20px;">The amount of seed money</th>
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab313","ch313");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_1_3", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab314","ch314");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_1_4", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab315","ch315");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_1_5", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab316","ch316");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_1_6", true);
         			   			 xhttp.send();
        		}
        	}
    ...
    <form>
        ...
        <table border="0" id="tab316">
            <tr>
                ...
                <th style="width:200px; padding:20px;">Funds Provided</th>
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab322","ch322");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_2_2", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab323","ch323");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_2_3", true);
         			   			 xhttp.send();
        		}
        	}
...
<center>
    	...
    	function addRow323()
    	{
            var i = get_time();
             var t = '<tr id = "'+i+'"><td><center><input type="text" placeholder="Name of Principal Investigator" style="width:200px;" required></center></td>'+
              '<td><center><input type="text" placeholder="Designation and Dept." style="width:200px;" required></center></td>'+
              '<td><center><input type="number" placeholder="Duration" style="width:160px;" required></center></td>'+
    ...
    <form>
        ...
        <table border="0" id="tab323">
            <tr>
                <th style="width:80px; padding:20px;">Name of the Principal Investigator/ Co Investigator</th>
                <th style="width:200px; padding:20px;">Designation and Dept</th>
                <th style="width:200px; padding:20px;">Duration (in Months) of the project</th>
                <th style="width:250px; padding:20px;">Name of the Research Project</th>
                <th style="width:200px; padding:20px;">Amount Sanctioned</th>
...
<center>
    ...
    <form>
        ...
        <textarea id="TAa1_1_1" style="margin-left:80px; width:930px;height:200px;  opacity:.82;">
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab332","ch332");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_3_2", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab333","ch333");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_3_3", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab334","ch334");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_3_4", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab341","ch341");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_4_1", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab342","ch342");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_4_2", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab343","ch343");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_4_3", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab344","ch344");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_4_4", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab345","ch345");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_4_5", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab346","ch346");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_4_6", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab347","ch347");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_4_7", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab348","ch348");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_4_8", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab351","ch351");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_5_1", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab352","ch352");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_5_2", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab353","ch353");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_5_3", true);
         			   			 xhttp.send();
        		}
        	}
...
<center>
    ...
    <form>
        ...
        <textarea id="TAaa1_1_1" style="margin-left:80px; width:930px;height:200px;  opacity:.82;">
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab362","ch362");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_6_2", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab363","ch363");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_6_3", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab364","ch364");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_6_4", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab371","ch371");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_7_1", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab372","ch372");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_7_2", true);
         			   			 xhttp.send();
        		}
        	}
        			...
        			var xhttp,res;
         			       ...
         			       if (this.readyState == 4 && this.status == 200) {
                               ...
                               num_rows("tab373","ch373");
          			   			 ...
          			   			 xhttp.open("GET", "saveData.php?rows="+rowss+"&table=t3_7_3", true);
         			   			 xhttp.send();
        		}
        	}
    ...
    <script>
    	function addRow373()
    	{
            var i = get_time();
              ...
              '<td><center><input type="text" placeholder="Institution Name" style="width:200px;" required></center></td>'+
              '<td><center><select placeholder="Period" class="year" style="width:165px;" required></select></center></td>'+
              '<td><center><input type="text" placeholder="Year" style="width:200px;" required></center></td>'+
...
?>       
        // 1.1.1
            ...
            if(document.getElementById("TA1_1_1").value==""){
               document.getElementById("ch361").innerHTML = '<img src="../images/unfilled.png" width="48" height="48"><br><a style="font-size:15px; color:#000;"> Not Filled</a>';
            }else{
               document.getElementById("ch361").innerHTML = '<img src="../images/filled.png" width="52" height="52"><a style="font-size:15px;color:#000;"> Filled</a>';
            }
          */  
/* <?php            
