...
mysqli_begin_transaction($connection);
	...
	$query = "Delete from ssr_m7_1_15 where Username like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query);
	$query = "Insert into ssr_m7_1_15 Values('".$_SESSION['username']."','".$_GET['lcd']."','".$_GET['lan']."')";
	//	$query = "Insert into ssr_m7_1_15 Values".$_POST['rows']."";
