...
mysqli_begin_transaction($connection);
	...
	$query = "Delete from ssr_m4_2_6 where Username like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query);
	$query = "Insert into ssr_m4_2_6 Values('".$_SESSION['username']."','".$_POST['last']."','".$_POST['method']."','".$_POST['users']."','".$_POST['teachers']."','".$_POST['students']."')";   // ".$_POST['rows']."";
