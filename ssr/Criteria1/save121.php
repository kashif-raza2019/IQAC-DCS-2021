  ...
  session_start();
     ...
     if($connection){
        if(does_url_exists($link)){
            ...
            $insertQuery = "INSERT INTO ssr_m1_2_1(username, Course_Name, Course_Code, Year_of_Introduction, activity, link_document) VALUES('$user', '$courseName', '$courseCode', '$yearIntro', '$activity', '$link')";
