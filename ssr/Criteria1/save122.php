  ...
  session_start();
     ...
     if($connection){
        if(does_url_exists($link)){
            $insertQuery = "INSERT INTO ssr_m1_2_2(username, Programme_Code, Programme_Name, Year_of_Introduction, Status_of_Implementation, Year_of_Implementation, Year_of_Revision, Percentage, link_document) VALUES('$user', '$programCode', '$programName', '$yearIntro', '$statusImplement', '$yearImplement', '$yearRevision', '$percent', '$link')";
