     ...
     if(isset($_POST['courseName'])){
         ...
         for($i=0; $i<count($courseName); $i++){
            ...
            //  $collageYear_clean = mysqli_real_escape_string($connection, $collageYear[$i]);
             ...
             $query = "INSERT INTO ssr_m1_3_2(username, courseName, courseCode, year, numberTimes, duration, numberStudent, numberStudentComplete, collageYear) VALUES('$user', '$courseName_clean', '$courseCode_clean', '$year_clean', '$numberTimes_clean', '$duration_clean', '$numberStudent_clean', '$numberStudentComplete_clean', 'Y2')";
