    ...
    save_log($_SESSION['username'],getUserIP(),$_SERVER['REQUEST_URI'],urlencode(http_build_query($_POST, '', '&amp;')),date_format($date, 'Y-m-d H:i:s'));
     if(isset($_POST['q1'])){
         ...
         for($i=0; $i<count($q1); $i++){ 
            ...
            $q4_n = $q4[$i];
            $q5_n = $q5;
             $query = "INSERT INTO ssr_m5_1_8(username, Year, Type_of_Approach, Number_of_queries_received, Number_of_queries_addressed , Select_option) VALUES('$user', '$q1_n', '$q2_n', '$q3_n', '$q4_n', '$q5_n')";
         }
         if($query!=''){
