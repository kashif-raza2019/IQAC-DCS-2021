     ...
     if(isset($_POST['programCode'])){
         ...
         for($i=0; $i<count($programName); $i++){
            ...
            //  $collageYear_clean = mysqli_real_escape_string($connection, $collageYear[$i]);
             ...
             $query = "INSERT INTO ssr_m2_1_1(username, programName, programCode, numberSeats, numberEligible, numberAdmit,  yearCollage) VALUES('$user','$programCode_clean',  '$programName_clean' ,'$numberSeats_clean',  '$numberEligible_clean', '$numberAdmit_clean',  'Y5')";
         }
         if($query!=''){
