...
$flag = false;
 if(isset($_POST['submit'])){
    ...
    $message_unwrap = $_POST['message'];
    $message = wordwrap($message_unwrap, 65);
    $body = "This is mail regarding Technical Query From \n".$deptName."\n content is as follows".$message."\n Regards".$adminName."";
...
<style>
  ...
  .inputTxt{
    ...
    <div class="contentContainer">
       <form method="POST">
            <h4 style="float:left;">Regarding:  &nbsp;</h4><input type="text" class="form-control" value="Technical Query" disabled>
            <br>
       ...
       <h4 style="text-align: center;">Or Via</h4>
        <br>
          <a href="mailto: davv.naac@gmail.com?subject=Technical Query&body=To IQAC," target="_blank" style="margin-bottom: 50px; padding-left: 45%;"><i class="fa fa-envelope" style="font-size: 98px; "></i></a>
        <br><br><br>
