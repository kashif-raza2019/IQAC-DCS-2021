...
<html>
    ...
    <body>
        ...
        <!-- Main Content -->
        <h2>Already Filled</h2>
        <div class="msgContainer">
            <p>Data For Department: <b><?php echo $dept;?></b><br>Roll Number: <b><?php echo $roll;?></b> And Name: <b><?php echo $fullName;?></b> is Already Submitted <br>Please Head Back to  :<i><a href="selection-page.php">Main Page</a></i></p>
        </div>
