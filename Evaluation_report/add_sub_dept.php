  ...
  .nn:hover,.nnn,.nnn:hover{
    ...
    <div>
      ...
      <form method="POST" action="add_handler.php">
        <br><br>
      Sub-Department Name <input required type="text" id="sub_dept" name="sub_dept" value="" placeholder="Name of Sub Department">
      <br><br>
      <input type="submit" value="ADD SUB DEPARTMENT" class="SAVE">
