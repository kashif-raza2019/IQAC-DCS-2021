...
<?php
  ...
  $query = "SELECT * FROM sub_department WHERE Username LIKE '".$_SESSION['username']."'";
...
?>
  ...
  <center>
    ...
    <b style="font-size:19px;">SUB DEPARTMENTS</b>

    <br><br>

    <div>

      <table class="bordered" border="2" style="border-radius:10px;">
      ...
      while($row = $res->fetch_assoc()){
        ...
        $query1 = "SELECT * FROM eval_report WHERE Username LIKE '".$_SESSION['username']."' AND sid LIKE ".$row['id']." ";
...
//        print_r($row1);
      ...
      ?>
        ...
        <tr>
          <td><b><?php echo strtoupper($row['sub_dept']); ?></b></td>
          <td><button onclick="location.href='evaluation_report.php?sid=<?php echo $row['id']; ?>&sd=<?php echo $row['sub_dept']; ?>'" class="btn-warning"><b>Evaluative Report</b></button></td>
          <center>
          ...
          <td><button onclick="location.href='edit_sub_dept.php?sid=<?php echo $row['id']; ?>&sd=<?php echo $row['sub_dept']; ?>'" class="btn-primary"><b>Edit</b></button></td>
          <td><button onclick="check('delete.php?sid=<?php echo $row['id']; ?>&sd=<?php echo $row['sub_dept']; ?>')" class="btn-danger"><b>Delete</b> </button></td>
          </tr>

          <script>
            function check(red){
              var x = confirm("Are you sure you want to delete a sub-department");
      ...
      <a href="add_sub_dept.php">
      <img style="width:50px;" src="../images/add2.png"><c style="text-decoration:none; color:black;">ADD SUB-DEPARTMENT</c>
      </a>

      <br><br><Br>

      <input style="width:300px;" type="button" onclick="location.href='export.php'" value="Export My Evaluation Report">
