...
<body>
    ...
    <div id="topLink">
        <a onclick="goBack()" style="cursor: pointer;" data-toggle="tooltip" data-placement="bottom" title="Go Back">Back</a>
        <h4 style="text-align: center; color: #fff; font-weight: bold;">Teacher's Feedback Form</h4>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl">
                <br>
                <h2 style="color: green; font-weight: bold;text-align: center;">Feedback Filled Succesfully</h2><br><br>
                <h4 style="text-align: center;">Thank you dear faculty member for filling out this form.</h4>
            </div>
        </div>
    </div>
    <!-- Footer -->
