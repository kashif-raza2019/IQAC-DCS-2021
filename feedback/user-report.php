...
<body>
    ...
    <br>
    <h2 style="text-align: center;">Feedback</h2><br>
    ...
    <table class="table table-borderless">
        <thead>
            ...
            <tr>
                <td style="text-align: center;"><a href="studentmale_report.php" class="btn btn-primary">CHECK</a></td>
                <td style="text-align: center;"><a href="studentfemale_report.php" class="btn btn-primary">CHECK</a></td>
                <td style="text-align: center;"><a href="alumni_report.php" class="btn btn-primary">CHECK</a></td>
                <td style="text-align: center;"><a href="teacher_report.php" class="btn btn-primary">CHECK</a></td>
                <td style="text-align: center;"><a href="employer_report.php" class="btn btn-primary">CHECK</a></td>
                <td style="text-align: center;"><a href="parent_report.php" class="btn btn-primary">CHECK</a></td>
            </tr>
        </thead>
    </table>
    </div>
