...
<body>
    ...
    <div id="topLink">
        ...
        <h4 style="text-align: center; color: #fff; font-weight: bold;">Parent's Feedback Form</h4>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl">
                ...
                <h4 style="text-align: center;">Thank you dear parent member for filling out this form.</h4>
            </div>
        </div>
    </div>
    <!-- Footer -->
