...
mysqli_begin_transaction($connection);
	...
	$query = "Delete from t6_1_2 where Username like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query);
	$query = "Insert into t6_1_2 Values('".$_SESSION['username']."','".urlencode($_GET['desc'])."','','".urlencode($_GET['link'])."')";   // ".$_POST['rows']."";
