...
//save_log($_SESSION['username'],getUserIP(),$_SERVER['REQUEST_URI'],urlencode(http_build_query($_POST, '', '&amp;')),date_format($date, 'Y-m-d H:i:s'));
	...
	$query = "select distinct * from t5_1_2 where Username like '".$_SESSION['username']."';";
	...
	while($row = $res->fetch_assoc()){
		...
		<td><center><input id="per'.$row['id_time'].'" type="number" value="'.$row['number_of_student_benefited'].'" placeholder="Percentage" style="width:120px;" required></center></td>
