...
<body class="BACK" onload="main_func()">
    ...
    <div id="myHeader" class="col-sm-12 Username" style="z-index:10; width:100%;">
        <center><div id="myHeader1" class="col-sm-1 Username" style="padding:10px; style='visibility:hidden;'"><a onclick="goBack()"><h4 style=" color:#fff; font-size:15px;cursor: pointer" ><?php echo "BACK";?></h4></a></div></center>
        <center><div id="myHeader2" class="col-sm-10 Username" style="padding:10px;"><h4 style=" color:#fff; font-size:18px;"><?php echo strtoupper($_SESSION['names'])." | HELP-DESK:  ".$_SESSION['to'];?></h4></div></center>
...
?>
		...
		<?php
				...
				$query = "Select * from help_desk WHERE (msg_from LIKE '".$_SESSION['to']."' AND msg_to LIKE 'iqac') OR (msg_to LIKE '".$_SESSION['to']."' AND msg_from LIKE 'iqac')";
...
<br><br><br>
  ...
  <div id="msg_div"  style="width:600px; border:solid 2px black; background-color:white; height:550px; border-radius:20px; position:absolute; margin-bottom:50px;">
      ...
      <div id="show" style=" padding-left:14px; padding-right:14px; padding-top:10px; margin-top:8px; border:solid 0px gray; overflow-y:scroll; height:414px; width:594px; border-radius:20px 20px 0px 0px;">
          ...
          <?php if( strtolower($row['msg_to']) == 'iqac'){ ?>
            <?php
          ...
          <?php if( strtolower($row['msg_from']) == 'iqac'){ ?>
    ...
    var xhttp,res;
          ...
          xhttp.onreadystatechange = function(){
           ...
           if (this.readyState == 4 && this.status == 200) {
               ...
               xhttp.open("POST", "send_superuser_msg_handler.php", true);
             xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
           xhttp.send("msg="+msg+"&to="+"<?php echo $_SESSION['to']; ?>");
  }
