    ...
    include("../credential.php");
      ...
      $connection = mysqli_connect($servername, $username, $password, $dbname);
       if(isset($_POST['submit'])){
        ...
        $eleven = $_POST['q11']; 
        $twelve = $_POST['q12'];  
        $sqlInsert = "INSERT INTO academic_criteria_2 (user, q1, q2, q3, q4, q5, q6, q7, q8, q9, q10, q11, q12) VALUES ('$user', '$one', '$two', '$three', '$four', '$five', '$six', '$seven', '$eight', '$nine', '$ten', '$eleven', '$twelve')";
       
        $sqlUpdate = "UPDATE academic_criteria_2 
          SET q1 = '$one',q2 = '$two',q3 = '$three', q4 ='$four', q5 = '$five', q6 = '$six', q7 = '$seven',q8 = '$eight',q9 = '$nine',q10 = '$ten',q11 = '$eleven',q12 = '$twelve' WHERE user = '$user'";
          
          $checkQuery = "SELECT * FROM academic_criteria_2 WHERE user = '$user'";
