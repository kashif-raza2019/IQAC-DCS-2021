    ...
    include("../credential.php");
      ...
      $connection = mysqli_connect($servername, $username, $password, $dbname);
       if(isset($_POST['submit'])){
        ...
        $two = $_POST['q2'];
        $three = $_POST['q3'];
        $sqlInsert = "INSERT INTO academic_criteria_6 (user, q1, q2, q3) VALUES ('$user', '$one', '$two', '$three')";
       
        $sqlUpdate = "UPDATE academic_criteria_6 
          SET q1 = '$one',q2 = '$two',q3 = '$three' WHERE user = '$user'";
          
          $checkQuery = "SELECT * FROM academic_criteria_6 WHERE user = '$user'";
