    ...
    include("../credential.php");
      ...
      $connection = mysqli_connect($servername, $username, $password, $dbname);
       if(isset($_POST['submit'])){
        ...
        $five = $_POST['q5'];
        $six = $_POST['q6'];
        $sqlInsert = "INSERT INTO academic_criteria_3 (user, q1, q2, q3, q4, q5, q6) VALUES ('$user', '$one', '$two', '$three', '$four', '$five', '$six')";
       
        $sqlUpdate = "UPDATE academic_criteria_3 
          SET q1 = '$one',q2 = '$two',q3 = '$three', q4 ='$four', q5 = '$five', q6 = '$six' WHERE user = '$user'";
          
          $checkQuery = "SELECT * FROM academic_criteria_3 WHERE user = '$user'";
