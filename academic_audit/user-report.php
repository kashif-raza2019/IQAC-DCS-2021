...
<title><?php echo "ACADEMIC AUDIT | REPORT";?></title>
</head>
<body>
        <script>
    ...
    <br>
    <h3 style="text-align: center; font-weight: bold;">Academic Audit Report</h3><br>
            ...
            <tbody>
                <?php
                    ...
                    while($getAdmin = $getQuery->fetch_assoc()){
                        ...
                        echo "<tr><td style='color: #0E3778; font-weight: bold' class='deptName'>$getAdminName</td><td><a href='userPdf.php?username=$getAdminData&name=$getAdminName'><i class='fa fa-file-pdf-o' style='font-size: 26px; color: red;'></i></a></td><td><a href='exportUser.php?username=$getAdminData&name=$getAdminName'><i class='fa fa-file-excel-o' style='font-size: 26px; color: green;'></i></a></td></tr>";
                    }
