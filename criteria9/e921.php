...
<?php
  ...
  $query = "SELECT * FROM t9_2_1 WHERE Username LIKE '".$_SESSION['username']."'";
...
<div style="visibility:hidden;">
  ...
  <center>
  <b style="font-size:20px; color:#565656;"> 9.2.1 Number of students enrolled year wise during the last five years </b>
  </center>
  ...
  <table border="1">
    ...
    <tr>
      <td><?php echo $c; ?></td>
      <td><?php echo $row['Year_of_Enrollment']; ?></td>
      <td><?php echo $row['Student_name']; ?></td>
      <td><?php echo $row['Student_Enrollment_no']; ?></td>
...
<br><br><br>
  ...
  <a href="templates/921.csv">Download Template of 9.2.1</a>
<br><br>
  <form method="POST" action="import_handler.php" enctype="multipart/form-data" style="width:400px;" onsubmit="return check_before_submit();">
    ...
    <input type="hidden" id="section" name="section" value="t9_2_1" style="width:200px;" required>
