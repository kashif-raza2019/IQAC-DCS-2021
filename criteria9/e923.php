...
<?php
  ...
  $query = "SELECT * FROM t9_2_3 WHERE Username LIKE '".$_SESSION['username']."'";
...
<div style="visibility:hidden;">
  ...
  <center>
  <b style="font-size:20px; color:#565656;"> 9.2.3 Number of students appeared in university examination year wise during last five years. </b>
  </center>
  ...
  <table border="1">
    ...
    <tr>
      ...
      <th>Date of appearing in exam</th>
      <th>Roll number</th>
    </tr>
    ...
    <tr>
      ...
      <td><?php echo $row['Date_of_appearing_in_exam']; ?></td>
...
<br><br><br>
  ...
  <a href="templates/923.csv">Download Template of 9.2.3</a>
<br><br>
  <form method="POST" action="import_handler.php" enctype="multipart/form-data" style="width:400px;" onsubmit="return check_before_submit();">
    ...
    <input type="hidden" id="section" name="section" value="t9_2_3" style="width:200px;" required>
