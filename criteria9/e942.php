...
<?php
  ...
  $query = "SELECT * FROM t9_4_2 WHERE Username LIKE '".$_SESSION['username']."'";
...
<div style="visibility:hidden;">
  ...
  <center>
  <b style="font-size:20px; color:#565656;"> 9.4.2 Number of seats earmarked for reserved category as per GOI/ State Govt rule year wise during last five years. </b>
  </center>
  ...
  <table border="1">
    ...
    <tr>
      <th>S. No.</th>
      <th>Year</th>
      <th>Number of seats earmarked for reserved category as per GOI/ State Govt rule</th>
    ...
    <tr>
      ...
      <td><?php echo $row['NUmber_of_seats_enmarked']; ?></td>
...
<br><br><br>
  ...
  <a href="templates/942.csv">Download Template of 9.4.2</a>
<br><br>
  <form method="POST" action="import_handler.php" enctype="multipart/form-data" style="width:400px;" onsubmit="return check_before_submit();">
    ...
    <input type="hidden" id="section" name="section" value="t9_4_2" style="width:200px;" required>
