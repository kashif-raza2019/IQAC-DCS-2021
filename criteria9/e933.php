...
<?php
  ...
  $query = "SELECT * FROM t9_3_3 WHERE Username LIKE '".$_SESSION['username']."'";
...
<div style="visibility:hidden;">
  ...
  <center>
  <b style="font-size:20px; color:#565656;"> 9.3.3 Number of sanctioned posts year wise during the last five years </b>
  </center>
  ...
  <table border="1">
    ...
    <tr>
      <th>S. No.</th>
      <th>Year</th>
      <th>Number of sanctioned posts year</th>
...
<br><br><br>
  ...
  <a href="templates/933.csv">Download Template of 9.3.3</a>
<br><br>
  <form method="POST" action="import_handler.php" enctype="multipart/form-data" style="width:400px;" onsubmit="return check_before_submit();">
    ...
    <input type="hidden" id="section" name="section" value="t9_3_3" style="width:200px;" required>
