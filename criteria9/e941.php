...
<?php
  ...
  $query = "SELECT * FROM t9_4_1 WHERE Username LIKE '".$_SESSION['username']."'";
...
<div style="visibility:hidden;">
  ...
  <center>
  <b style="font-size:20px; color:#565656;"> 9.4.1 Number of eligible applications received for admissions to all the programs year wise during the last five years. </b>
  </center>
  ...
  <table border="1">
    ...
    <tr>
      <th>S. No.</th>
      <th>Year</th>
      <th>Number of  eligible applications received for admissions to all the programs</th>
    ...
    <tr>
      ...
      <td><?php echo $row['Number_of_eligible_application_recieved']; ?></td>
...
<br><br><br>
  ...
  <a href="templates/941.csv">Download Template of 9.4.1</a>
<br><br>
  <form method="POST" action="import_handler.php" enctype="multipart/form-data" style="width:400px;" onsubmit="return check_before_submit();">
    ...
    <input type="hidden" id="section" name="section" value="t9_4_1" style="width:200px;" required>
