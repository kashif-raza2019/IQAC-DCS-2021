...
<?php
  ...
  $query = "SELECT * FROM t9_3_2a WHERE Username LIKE '".$_SESSION['username']."'";
...
<div style="visibility:hidden;">
  ...
  <center>
  <b style="font-size:20px; color:#565656;"> 9.3.2(a) Number of full time teachers presently working in the institutions </b>
  </center>
...
<br><br><br>
  ...
  <a href="templates/932a.csv">Download Template of 9.3.2(a)</a>
<br><br>
  <form method="POST" action="import_handler.php" enctype="multipart/form-data" style="width:400px;" onsubmit="return check_before_submit();">
    ...
    <input type="hidden" id="section" name="section" value="t9_3_2a" style="width:200px;" required>
    <input type="hidden" id="expected_c" name="expected_c" value="6" style="width:200px;" required>
