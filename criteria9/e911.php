...
<?php
  ...
  $query = "SELECT * FROM t9_1_1 WHERE Username LIKE '".$_SESSION['username']."'";
...
<div style="visibility:hidden;">
  ...
  <center>
  <b style="font-size:20px; color:#565656;"> 9.1.1 Number of programs offered year wise during last five years </b>
  </center>
...
<br><br><br>
  ...
  <a href="templates/911.csv">Download Template of 9.1.1</a>
<br><br>
  <form method="POST" action="import_handler.php" enctype="multipart/form-data" style="width:400px;" onsubmit="return check_before_submit();">
    ...
    <input type="hidden" id="section" name="section" value="t9_1_1" style="width:200px;" required>
