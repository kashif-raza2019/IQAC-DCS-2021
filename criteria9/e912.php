...
<?php
  ...
  $query = "SELECT * FROM t9_1_2 WHERE Username LIKE '".$_SESSION['username']."'";
...
<div style="visibility:hidden;">
  ...
  <center>
  <b style="font-size:20px; color:#565656;"> 9.1.2 Number of programs added or dropped year wise during the last five years </b>
  </center>
  ...
  <table border="1">
    ...
    <tr>
      <th>S. No.</th>
      <th>Program code of added/dropped programs</th>
      <th>Programs name of added programs</th>
      <th>Programs name of dropped programs</th>
      <th>Year of addition or dropping out</th>
    </tr>
    ...
    <tr>
      ...
      <td><?php echo $row['Prog_Name_Added']; ?></td>
      <td><?php echo $row['Prog_Name_Drpoed']; ?></td>
      <td><?php echo $row['Year_add_drop']; ?></td>
    </tr>
...
<br><br><br>
  ...
  <a href="templates/912.csv">Download Template of 9.1.2</a>
<br><br>
  <form method="POST" action="import_handler.php" enctype="multipart/form-data" style="width:400px;" onsubmit="return check_before_submit();">
    ...
    <input type="hidden" id="section" name="section" value="t9_1_2" style="width:200px;" required>
    <input type="hidden" id="expected_c" name="expected_c" value="4" style="width:200px;" required>
