...
<?php
  ...
  $query = "SELECT * FROM t9_3_2b WHERE Username LIKE '".$_SESSION['username']."'";
...
<div style="visibility:hidden;">
  ...
  <center>
  <b style="font-size:20px; color:#565656;"> 9.3.2(b) Number of full time teachers who left/joined the institution during the last five years </b>
  </center>
  ...
  <table border="1">
    ...
    <tr>
      ...
      <td><?php echo $row['year_joined_left']; ?></td>
...
<br><br><br>
  ...
  <a href="templates/932b.csv">Download Template of 9.3.2(b)</a>
<br><br>
  <form method="POST" action="import_handler.php" enctype="multipart/form-data" style="width:400px;" onsubmit="return check_before_submit();">
    ...
    <input type="hidden" id="section" name="section" value="t9_3_2b" style="width:200px;" required>
    <input type="hidden" id="expected_c" name="expected_c" value="8" style="width:200px;" required>
