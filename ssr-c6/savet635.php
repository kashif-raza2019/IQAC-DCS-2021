...
mysqli_begin_transaction($connection);
	...
	$query = "Delete from ssr_m6_3_5 where Username like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query);
	$query = "Insert into ssr_m6_3_5 Values('".$_SESSION['username']."','".urlencode($_GET['desc'])."','','".urlencode($_GET['link'])."')";   // ".$_POST['rows']."";
