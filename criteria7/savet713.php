...
mysqli_begin_transaction($connection);
	...
	$query = "Delete from t7_1_3 where Username like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query);
	$query = "Insert into t7_1_3 Values('".$_SESSION['username']."','".$_GET['lcd']."','".$_GET['lan']."','".$_GET['semi']."','".$_GET['totalc']."','".$_GET['totals']."')"; 
