...
<body>
    ...
    <br>
    <h3 style="text-align: center; font-weight: bold;">Hon'ble VICE-CHANCELLER's MONTHLY REPORT</h3><br>
            ...
            <tbody>
                <?php
                    ...
                    while($getAdmin = $getQuery->fetch_assoc()){
                        ...
                        echo "<tr><td style='color: #0E3778; font-weight: bold' class='deptName'>$getAdminName</td><td><a href='userPdf.php?username=$getAdminData&name=$getAdminName&month=$month'><i class='fa fa-file-pdf-o' style='font-size: 26px; color: red;'></i></a></td><td><a href='../Monthly_Export/exportUserFull.php?username=$getAdminData&name=$getAdminName&month=$month&year=$year'><i class='fa fa-file-excel-o' style='font-size: 26px; color: green;'></i></a></td></tr>";
                    }
