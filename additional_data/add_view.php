...
<body class="BACK" onload="load_time_func();" style="font-family:ubuntu;">
    ...
    <center>
        ...
        <div class="col-sm-12"  style="margin-top:0px;">
            <br>
            <center><a style="color:black; ;;;; font-weight:normal; font-size:22px;">UPLOAD ADDITIONAL DATA</a></center>
        </div>
        ...
        <div class="col-sm-12">
          ...
          <table border="2" style="padding:5px;">
            ...
            $query = "Select * FROM t_additional_data WHERE Username LIKE '".$_SESSION['username']."' AND deactive = 0";
            //echo $query."<br>";
            ...
            <tr id="<?php echo $row['id']; ?>">
              ...
              <td style="width:80px;"> <button onclick="deactivate_data(this)" id="del" type="button" class="btn-danger" name="del" value="<?php echo $row['id']; ?>" style="padding:3px;">Delete</button> </td>
            </tr>
    ...
    <table>
      ...
      <tr>
        ...
        <td>
          ...
          <select id="section" name="section" style="width:150px;">
            <option value="">Select Section</option>
<?php
  $connection = mysqli_connect($servername, $username, $password, $dbname);
  $query = "Select * FROM na_table_div_id WHERE 1";
  //echo $query."<br>";
  $res  = mysqli_query($connection,$query);// or die(mysqli_error($connection));
    while ($row=$res->fetch_assoc()) {
?>

      <option value='<?php echo $row['table']; ?>'><?php echo str_replace("t","",str_replace("_",".",$row['table'])); ?></option>
...
?>
        ...
        <td>
          <select id="type" name="type" style="width:200px;">
            ...
            <option value="supporting">Supporting Data</option>
        ...
        <td>
          <input type="button" value="ADD" onclick="upload_and_generate_link()">
        </td>
      </tr>
