...
<title><?php echo "MONTHLY  REPORT";?></title>
</head>
<body>
        <script>
    ...
    <br>
    <h3 style="text-align: center; font-weight: bold;">Hon'ble VICE-CHANCELLER's MONTHLY REPORT CSV</h3><br>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary" onclick="location.href='exportUser1.php'">Click to Download</button>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <button class="btn btn-primary" onclick="location.href='exportUser2.php'">Click to Download</button>
                    </td>
                </tr>
                <tr>
                    <th>
                    III (a). One Member from the Management
                    </th>
                    <td>
                        <button class="btn btn-primary" onclick="location.href='exportUser3.php'">Click to Download</button>
                    </td>
                </tr>
                <tr>
                    <th>
                    III (b). One/Two Nominees from Local Society, Students and Alumni
                    </th>
                    <td>
                        <button class="btn btn-primary" onclick="location.href='exportUser4.php'">Click to Download</button>
                    </td>
                </tr>
                <tr>
                    <th>
                    IV. One/Two Nominees From Employer/Industrialist/Stakeholders
                    </th>
                    <td>
                        <button class="btn btn-primary" onclick="location.href='exportUser5.php'">Click to Download</button>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <button class="btn btn-primary" onclick="location.href='exportUser6.php'">Click to Download</button>
                    </td>
                </tr>
                <tr>
                    <th>
                    Conclusion/ Remarks for DQAC
                    </th>
                    <td>
                        <button class="btn btn-primary" onclick="location.href='exportUser7.php'">Click to Download</button>
                    </td>
                </tr>
