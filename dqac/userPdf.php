    ...
    */
    ...
    class PDF extends FPDF
    {
        ...
        $user = $_GET['username'];
            ...
            $this->Ln();
            $this->Cell(300,10,'D.Q.A.C. COMPOSTION',0,0,'C');
            $this->Ln(20);
        ...
        function viewTable($connect){
                ...
                while($row2 = mysqli_fetch_assoc($result2)){
                    ...
                    $this->Cell(75, 10, $row2['name'], 1, 0, 'L');
                    $this->Cell(50, 10, $row2['designation'], 1, 0, 'L');
                    $this->Cell(50, 10, $row2['affiliation'], 1, 0, 'L');
                    $this->Cell(60, 10, $row2['email'], 1, 0, 'L');
                    $this->Cell(30, 10, $row2['contact'], 1, 0, 'L');
                    $this->Ln();
                    $i++;
                ...
                while($row3 = mysqli_fetch_assoc($result3)){
                    $i = 1;
                    $this->Cell(15, 10, $i, 1, 0, 'L');
                    $this->Cell(75, 10, $row3['name'], 1, 0, 'L');
                    $this->Cell(50, 10, $row3['designation'], 1, 0, 'L');
                    $this->Cell(50, 10, $row3['affiliation'], 1, 0, 'L');
                    $this->Cell(60, 10, $row3['email'], 1, 0, 'L');
                    $this->Cell(30, 10, $row3['contact'], 1, 0, 'L');
                    $this->Ln();
                    $i++;
                ...
                while($row4 = mysqli_fetch_assoc($result4)){
                    $i = 1;
                    $this->Cell(15, 10, $i, 1, 0, 'L');
                    $this->Cell(75, 10, $row4['name'], 1, 0, 'L');
                    $this->Cell(50, 10, $row4['designation'], 1, 0, 'L');
                    $this->Cell(50, 10, $row4['affiliation'], 1, 0, 'L');
                    $this->Cell(60, 10, $row4['email'], 1, 0, 'L');
                    $this->Cell(30, 10, $row4['contact'], 1, 0, 'L');
                    $this->Ln();
                    $i++;
                ...
                while($row5 = mysqli_fetch_assoc($result5)){
                    $i = 1;
                    $this->Cell(15, 10, $i, 1, 0, 'L');
                    $this->Cell(75, 10, $row5['name'], 1, 0, 'L');
                    $this->Cell(50, 10, $row5['designation'], 1, 0, 'L');
                    $this->Cell(50, 10, $row5['affiliation'], 1, 0, 'L');
                    $this->Cell(60, 10, $row5['email'], 1, 0, 'L');
                    $this->Cell(30, 10, $row5['contact'], 1, 0, 'L');
                    $this->Ln();
                    $i++;
                ...
                while($row6 = mysqli_fetch_assoc($result6)){
                    $i = 1;
                    $this->Cell(15, 10, $i, 1, 0, 'L');
                    $this->Cell(75, 10, $row6['name'], 1, 0, 'L');
                    $this->Cell(50, 10, $row6['designation'], 1, 0, 'L');
                    $this->Cell(50, 10, $row6['affiliation'], 1, 0, 'L');
                    $this->Cell(60, 10, $row6['email'], 1, 0, 'L');
                    $this->Cell(30, 10, $row6['contact'], 1, 0, 'L');
                    $this->Ln();
                    $i++;
