...
<div class="col-sm-12" style="height:50px;">
    ...
    <div class="col-sm-12" onclick='rotate("tg111"); $("#d111").slideToggle("slow");'>
        ...
        <div id="h111" class="col-sm-10">
            <div class="col-sm-1"  style="font-size:18px;">1.1.1</div>
...
<script>
    ...
    <div class="col-sm-12" onclick='rotate("tg112"); $("#d112").slideToggle("slow");'>
        ...
        <div id="h112" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>1.1.2</div>
            <div class="col-sm-11" style="font-size:18px;">
...
<center>
    ...
    <script>
    	...
    	function addRow112()
    	{
            ...
            var html = '<tr id="'+i+'"><td><center><select id="'+ip+'" onchange="fetch_course_code(this.value,this.id)" text="Programme Code" style="width:150px;" required></select></center></td><td><center><input id="'+ipn+'" type="text" placeholder="Programme Name" style="width:250px;" disabled></center></td> <td><center><select placeholder="Year" style="width:165px;" id="'+ay+'"></select></center></td><td><center><input id="'+per+'" type="number" step="0.5" min="0" max="100" onkeyup="percent_limit_input(this.value,this.id,event)"  placeholder="Percentage" style="width:120px;" required></center></td><td class="remove"><center><button onclick="remove_row(this);" type="button" >Remove</button></center></td></tr>';
    		var x = $('#tab112').find('tr');		
...
-->
    ...
    <div class="col-sm-12" onclick='rotate("tg113"); $("#d113").slideToggle("slow");'>
        ...
        <div id="h113" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>1.1.3</div>
            <div class="col-sm-11" style="font-size:18px;">
...
<div class="col-sm-12" style="height:30px;">
    ...
    <div class="col-sm-12" onclick='rotate("tg121"); $("#d121").slideToggle("slow");'>
        ...
        <div id="h121" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>1.2.1</div>
            <div class="col-sm-11" style="font-size:18px;">
...
<script>
    ...
    <div class="col-sm-12" onclick='rotate("tg122"); $("#d122").slideToggle("slow");'>
        ...
        <div id="h122" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>1.2.2</div>
            <div class="col-sm-11" style="font-size:18px;">
            <br>
...
<center>
    <div class="col-sm-12" id="d122">
        ...
        function addRow122()
    	{
    		...
    		var html = '<tr id="'+i+'" ><td><center><select id="'+ip+'" onchange="fetch_course_code(this.value,this.id)" text="Programme Code" style="width:150px;" required></select></center></td><td><center><input id="'+ipn+'" type="text" placeholder="Programme Name" style="width:250px;" disabled></center></td><td width="300px"><center><input type="radio" name="type'+radioNumber122+'" value="CBCS">CBCS  <input type="radio" name="type'+radioNumber122+'" value="Elective"> Elective</center></td><td><center><select id="'+ay+'" placeholder="Year" style="width:165px;" required></select></center></td><td class="remove"><center><button onclick="remove_row(this);" type="button">Remove</button></center></td></tr>';
    		radioNumber122++;
    		var x = $('#tab122').find('tr');		
   			$(x[x.length-1]).before(html);
...
<div class="col-sm-12" style="height:30px;">
    ...
    <div class="col-sm-12" onclick='rotate("tg131"); $("#d131").slideToggle("slow");'>
        ...
        <div id="h131" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>1.3.1</div>
            <div class="col-sm-11" style="font-size:18px;">
            <br>
...
<!--1.3.2-->
    ...
    <div class="col-sm-12" onclick='rotate("tg132"); $("#d132").slideToggle("slow");'>
        ...
        <div id="h132" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>1.3.2</div>
            <div class="col-sm-11" style="font-size:18px;">
            <br>
...
<center>    
    <div class="col-sm-12" id="d132">
        ...
        function addRow132()
    	{
    		...
    		var html = '<tr id="'+i+'" ><td><center><select id="'+ip+'" onchange="fetch_course_code(this.value,this.id)" text="Programme Code" style="width:150px;" required></select></center></td><td><center><select id="'+ic+'" onchange="fetch_course_name(this.value,this.id)" text="Course Code" style="width:150px;" required></select></center></td><td><center><input id="'+icn+'" type="text" placeholder="Course Name" style="width:250px;" disabled></center></td><td><center><select id="'+ay+'" placeholder="Year Offering" style="width:170px;" required></select></center></td><td><center><input type="number" step="1" min="0" onkeypress="return event.charCode >= 48" style="width:80px;" required></center></td><td><center><select id="'+ay1+'" placeholder="Year Discontinued" style="width:170px;" required></select></center></td><td><center><input type="number" step="1" min="0" onkeypress="return event.charCode >= 48" style="width:80px;" required></center></td><td><center><input type="number" step="1" min="0" onkeypress="return event.charCode >= 48" style="width:80px;" required></center></td><td class="remove" style="width:40px;"><center><button onclick="remove_row(this);" type="button">Remove</button></center></td></tr>';
...
<!--1.3.4-->
    ...
    <div class="col-sm-12" onclick='rotate("tg134"); $("#d134").slideToggle("slow");'>
        ...
        <div id="h134" class="col-sm-10" >
            <div class="col-sm-1"  style="font-size:18px;"><br>1.3.4</div>
            <div class="col-sm-11" style="font-size:18px;">
            <br>
...
?>       
        // 1.1.1
            var t = document.getElementById("TA1_1_1").value = '<?php echo $row["Description"]; ?>';
            //alert(t);
