...
mysqli_begin_transaction($connection);
	...
	$query = "Delete from t1_1_1 where Username like '".$_SESSION['username']."';";
	$res  = mysqli_query($connection,$query);
	$query = "Insert into t1_1_1 Values('".$_SESSION['username']."','".urlencode($_POST['desc'])."','','".urlencode($_POST['link'])."')";   // ".$_POST['rows']."";
